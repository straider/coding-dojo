...
- Offers **print()** and **write()** to output to console;
- Doesn't cope well with UTF-8 encoding mode;
- Handles String concatenation with operator "+";
- Handles String interpolation with operator "%" or **String.format()**;
- Requires _sys_ module to handle command line arguments.
