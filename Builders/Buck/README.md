coding-dojo / Builders / Buck
=============================

Dojo to learn and explore Buck, one of the Java Builder Tools.
...
This dojo is suitable to any programmer that wants to learn how to work with Buck in order to build Java projects.
...
~~Buck, by convention, assumes specific folder paths for its sourceSets:~~
