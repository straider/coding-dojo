...
use_ok 'ScoreController v1.00.00';
...
is_deeply ( \@start_score_result, \@start_score_lines, 'show_score() using score at start' );
...
is_deeply ( \@final_score_result, \@final_score_lines, 'show_score() using score at final' );
